package com.android.lv.imageswitcher.view.datepicker;
...
import com.android.lv.imageswitcher.view.datepicker.DatePickerView;
...
public class ZuvDatePicker {
    ...
    public ZuvDatePicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.datepicker_view);
     ...
     * 设置日期控件是否显示 年月日
     */
    public void showProbablyTime(boolean show){
        if (canAccess) {
            if (show) {
                disScrollUnit();
