        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.bt_add_deter:
                    ...
                    {
                        Toast.makeText(AddImageActivity.this, "请选择图片", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    m_application.saveImage(imageItem);

                    Log.i(TAG, "[Size]" + m_application.getImages().size());
                    Toast.makeText(AddImageActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
                    finish();
