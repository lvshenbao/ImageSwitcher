...
public class ImageIndicatorView extends RelativeLayout {
	private static final String TAG = "ImageIndicatorView";
	/**
	 * ViewPager控件
	 */
	...
	private void init(Context context) {
		LayoutInflater.from(context).inflate(R.layout.ii_image_indicator_layout, this);
	...
	{
		this.indicateLayout.setVisibility(show?VISIBLE:GONE);
	}
	...
	protected void refreshIndicateView() {
		...
		if (this.onItemChangeListener != null) {// 页面改更了
			try {
				Log.d(TAG, "onItemChangeListener");
